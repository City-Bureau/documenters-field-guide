...
>
>**In Cleveland:** _Hi, I'll be live-tweeting today's (name/title of event) for #CLEdocumenters @CLEdocumenters & @signalcleveland
>
>  **In Detroit:** _Hi, I’ll be live-tweeting today's (name/title of event) for #DETdocumenters @DetDocumenters media partners: @BridgeDet313 @chalkbeatDET @freep @metrotimes @MichiganRadio @media\_outlier @PlanetDetroit @wdet @wxyzdetroit
>
> **In Fresno:** _Hi, I'll be live-tweeting today's (name/title of event) for #FREdocumenters @fresnoland
> 
> **In Omaha:** _Hi, I'll be live-tweeting today's (name/title of event) for #OMAdocumenters @oma\_documenters
